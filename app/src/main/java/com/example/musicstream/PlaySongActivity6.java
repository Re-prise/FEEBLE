...
public class PlaySongActivity6 extends AppCompatActivity {
...
//    }
    ...
    public void teleportToHome(View view){startActivity(new Intent(PlaySongActivity6.this,MainActivity.class));}
    //onClick from Toolbar(settings) to Settings Activity
    public void teleportToSettings(View view){startActivity(new Intent(PlaySongActivity6.this,SettingsActivity.class));}
    //onClick from Toolbar(collections) to Collections Activity
    public void teleportToCollections(View view){startActivity(new Intent(PlaySongActivity6.this,CollectionsActivity.class));}
